...
describe('Reduce parent balance of UniversalNode P', () => {
    ...
    it('all parents have balance of 1 FLR', () => {
...
describe('Reduce parent balance of UniversalNode X', () => {
    ...
    it('all nodes have balance of 1 FLR', () => {
        let balX = new BN(1000000000);
        let balP = new BN(1000000000);
        let balC = new BN(1000000000);
    ...
    it('both parents have balance of 1 FLR', () => {
        let balX = new BN(0);
        let balP = new BN(1000000000);
        let balC = new BN(1000000000);
    ...
    it('parent P has balance of 1 FLR', () => {
        let balX = new BN(0);
        let balP = new BN(1000000000);
        let balC = new BN(0);
    ...
    it('parent C has balance of 1 FLR', () => {
        let balX = new BN(0);
        let balP = new BN(0);
        let balC = new BN(1000000000);
...
describe('Reduce parent balance of UniversalNode C', () => {
    ...
    it('parent X has balance of 1 FLR', () => {
        let balX = new BN(1000000000);
        let balP = new BN(0);
        let balC = new BN(0);
...
describe('Get transactions for balance on UniversalNode P', () => {
    ...
    it('node needs balance from both parents and self', () => {
        let balP = new BN(1_000_000_000); // 1 FLR
        let balX = new BN(500_000_000); // 0.5 FLR
        let balC = new BN(2_000_000_000); // 2 FLR

        let nodeP = createGraphForP(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(2_000_000_000); // 2 FLR
    ...
    it('node needs balance from both parents', () => {
        let balP = new BN(0); // 0 FLR
        let balX = new BN(1_000_000_000); // 1 FLR
        let balC = new BN(2_000_000_000); // 2 FLR
    ...
    it('not enough balance', () => {
        ...
        let nodeP = createGraphForP(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(20_000_000_000); // 2 FLR
...
describe('Get transactions for balance on UniversalNode X', () => {
    ...
    it('node needs balance from parent P', () => {
        let balX = new BN(0);
        let balP = new BN(5_000_000_000); // 5 FLR
        let balC = new BN(0);
    ...
    it('node needs balance from P, both parent have balance', () => {
        let balX = new BN(0);
        let balP = new BN(5_000_000_000); // 5 FLR
        let balC = new BN(5_000_000_000); // 5 FLR
    ...
    it('node needs balance from both parents', () => {
        ...
        let nodeX = createGraphForX(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(1_000_000_000); // 1 FLR
    ...
    it('not enough balance', () => {
        let balP = new BN(1_000_000_000); // 0 FLR
        let balX = new BN(1_000_000); // 1 FLR
        let balC = new BN(2_000_000_000); // 2 FLR
