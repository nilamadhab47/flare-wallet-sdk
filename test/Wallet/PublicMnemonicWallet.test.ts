...
describe('Public Mnemonic Wallet', () => {
    ...
    it('can get correct addresses', () => {
        let wallet = new PublicMnemonicWallet(XPUB_AVAX, XPUB_ETH_ADDR);
        expect(wallet.getAddressX()).toEqual(`X-flare19v8flm9qt2gv2tctztjjerlgs4k3vgjs79x5h9`);
        expect(wallet.getAddressP()).toEqual(`P-flare19v8flm9qt2gv2tctztjjerlgs4k3vgjs79x5h9`);
        expect(wallet.getChangeAddressX()).toEqual(`X-flare1fp5jw95s3s0sgylt5yvegpu03k5aggtykrq34c`);
        expect(wallet.getAddressC()).toEqual(`0x6a23c16777a3A194b2773df90FEB8753A8e619Ee`);
        expect(wallet.getEvmAddressBech()).toEqual(`C-flare1t5dhkc4myzvyqsct3dmaue2hc43na8qhx8mwu8`);
    });
});
